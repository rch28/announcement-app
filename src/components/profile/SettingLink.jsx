...
const SettingLink = ({title, desc, link}) => {
  return (
    <div className=" bg-white shadow-lg hover:shadow-lg shadow-gray-400 hover:shadow-gray-500 border hover:border-purple-400 rounded-xl hover:scale-105 transition-all ease-linear p-4">
