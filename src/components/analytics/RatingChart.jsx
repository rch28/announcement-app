  ...
  useEffect(()=>{
    const fetchData = (async ()=>{
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_DB_BASE_URL}/analytics/group/${group_id}/rate/?range=${selectedFilter}`,
        {
          method: "GET",
          headers: {
  ...
  return (
    <div className="w-[500px] h-fit shadow-custom-all p-10 rounded-xl">
      <div className="flex justify-between items-center mb-6">
        <h1 className="font-bold text-lg">Group Rate</h1>
