...
const AnnouncementImpression = ({ann_id}) => {
  ...
  useEffect(()=>{
    const fetchData = (async ()=>{
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_DB_BASE_URL}/analytics/announcement/${ann_id}/impression/?range=${selectedFilter}`,
        {
          method: "GET",
          headers: {
...
export default AnnouncementImpression;
